...
public partial class GameData
{
    ...
    public static string[] PROFFESIONS = { "Accountant", "Lawyer", "Counselor", "Doctor", "Actor", "Zoo Keeper", "Investigator", "Broker", "Teacher", "Student", "Pilot", "Barber", "Bartender", "Baker", "Construction", "Chiropractor", "Clergy", "Game Designer", "Dancer", "Driller", "RuffNeck", "Fire Fighter", "Scientist", "Pool Shark", "Athlete", "Farmer", "Janitor", "Jeweler", "Investor", "Clerk", "Taxi Driver", "Seamstriss", "Worker", "Dog Walker", "Mechanic", };
    public static string[] LEGAL_BUSINESS_NAMES = { "Warehouse", "Storage", "Pawn Shop", "Accounting", "Plumbing", "Plumbing", "Temple", "School", "Computer Repair", "Retail Store", "Grocery Store", "Meat Market", "Skating Ring", "Day Spa", "Music Store", "Tax Agency", "Real Estate", "Plumbing", "Plumbing", "Plumbing", "Insurance Company", "Clothing Store", "Dentist", "Pizza Store", "Restaurant", "Flower Store", "Auto Repair", "Tire Shop", "Candy Store", "Coffee Shop", "Gun Store", "Furniture Store", "Brewery", "Gas Station", "Party Planners", "Staffing Agency", "Sporting Goods", "High School", "College", "Marketing Agency", "Manufactoring", "Recycling", "Arts & Hobbies", "Arcade", "Liquor Store", "Tools Store", };
    public static string[] ILLLEGAL_BUSINESS_NAMES = { "Fight CLub", "Cock Fighting", "Dog Fighting", "Brothel", "Moonshine", "Guns", "Chop Shop", "Drug Lab", "Casino", "Porn Studio" };
