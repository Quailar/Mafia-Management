...
public class CharacterCreationManager : MonoBehaviour
{
    ...
    public Button HeadIncreaseButton;
    public Button bodyIncreaseButton;
    public Button HeadDecreaseButton;
    public Button bodyDecreaseButton;
    public Button changeAnimation;
