...
public class Graph<TNodeType, TEdgeType>
{
    public Graph()
    {
        EnterNodes = new List<Node<TNodeType>>();
        ExitNodes = new List<Node<TNodeType>>();
        Edges = new List<Edge<TEdgeType, TNodeType>>();
    }
    public List<Node<TNodeType>> EnterNodes { get; private set; }
    public List<Node<TNodeType>> ExitNodes { get; private set; }
